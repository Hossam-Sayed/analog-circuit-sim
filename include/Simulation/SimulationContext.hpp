...
public:
    ...
    const bool &isDC() const { return type == SimulationType::OP; }
    const bool &isAC() const { return type == SimulationType::AC; }
    const bool &isTRAN() const { return type == SimulationType::TRAN; }
